...
(function (root, factory) {
    ...
    vec3.fromValues = vec3.createFrom;
    /**
    ...
    quat4.inverse = function (quat, dest) {
        var q0 = quat[0], q1 = quat[1], q2 = quat[2], q3 = quat[3], dot = q0 * q0 + q1 * q1 + q2 * q2 + q3 * q3, invDot = dot ? 1.0 / dot : 0;
    ...
    quat4.multiplyVec3 = function (quat, vec, dest) {
        ...
        var x = vec[0], y = vec[1], z = vec[2], qx = quat[0], qy = quat[1], qz = quat[2], qw = quat[3], 
        // calculate quat * vec
    ...
    vec2.dist = function (vecA, vecB) {
        var x = vecB[0] - vecA[0], y = vecB[1] - vecA[1];
    ...
    vec2.direction = function (vecA, vecB, dest) {
        ...
        var x = vecA[0] - vecB[0], y = vecA[1] - vecB[1], len = x * x + y * y;
        if (!len) {
            dest[0] = 0;
            dest[1] = 0;
            dest[2] = 0;
    ...
    mat2.multiply = function (matA, matB, dest) {
        ...
        var a11 = matA[0], a12 = matA[1], a21 = matA[2], a22 = matA[3];
    ...
    mat2.rotate = function (mat, angle, dest) {
        ...
        var a11 = mat[0], a12 = mat[1], a21 = mat[2], a22 = mat[3], s = Math.sin(angle), c = Math.cos(angle);
        dest[0] = a11 * c + a12 * s;
        dest[1] = a11 * -s + a12 * c;
        dest[2] = a21 * c + a22 * s;
        dest[3] = a21 * -s + a22 * c;
    ...
    mat2.scale = function (matrix, vec, dest) {
        ...
        var a11 = matrix[0], a12 = matrix[1], a21 = matrix[2], a22 = matrix[3], b11 = vec[0], b22 = vec[1];
        dest[0] = a11 * b11;
        dest[1] = a12 * b22;
        dest[2] = a21 * b11;
        dest[3] = a22 * b22;
