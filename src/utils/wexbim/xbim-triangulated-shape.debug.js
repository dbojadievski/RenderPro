...
// This will get the xBinaryReader on the current position and will parse its content to fill itself with vertices, normals and vertex indices.
xTriangulatedShape.prototype.parse                                      = function ( binReader )
{
    ...
    /* Allocate memory of a defined size (to avoid reallocation of memory). */
...
//This would load only the shape data from binary file.
...
// This won't get called after the parsing which happens during large operations.
